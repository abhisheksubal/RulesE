...
The rule engine is designed to be extensible, allowing you to add custom rule types beyond the built-in Simple, Expression, and Composite rules. This section outlines the steps to create and integrate new rule types.
...
### Step 2: Update the Rule Definition Model
...
### Step 3: Extend the JsonRuleParser
...
### Step 4: Document the New Rule Type

1. Add documentation for your custom rule type in the "Rule Definition Format" section of the README, including:
   - JSON schema
